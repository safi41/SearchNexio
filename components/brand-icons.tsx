...
/* ---- Ecommerce platform marks ----
   ...
   Simplified from the official marks so they read at small sizes. */

export function ShopifyMark({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden>
      <circle cx="16" cy="16" r="16" fill="#95BF47" />
      <path
        fill="#fff"
        d="M20.9 9.7a.2.2 0 0 0-.18-.17c-.08 0-1.63-.12-1.63-.12s-1.08-1.07-1.2-1.19c-.12-.12-.35-.08-.44-.06l-.6.19a4.3 4.3 0 0 0-.29-.72c-.43-.82-1.06-1.26-1.82-1.26h-.2a1.3 1.3 0 0 0-.1-.11 1.6 1.6 0 0 0-1.22-.47c-.98.03-1.95.74-2.74 1.99-.56.88-.98 1.98-1.1 2.83l-1.93.6c-.57.18-.59.2-.66.73L5.4 24.3l10.5 1.97 5.55-1.38S20.92 9.83 20.9 9.7zm-6.06-1.5-1.62.5c.15-.6.44-1.2.79-1.58.13-.15.31-.31.53-.4.2.43.25 1.03.3 1.48zm-1.3-2.5c.17 0 .32.04.44.11-.2.11-.4.27-.58.47-.47.5-.83 1.29-.97 2.05l-1.33.41c.26-1.22 1.28-3 2.44-3.04zm-1.85 8.55c.05.8 2.15 .97 2.27 2.84.09 1.47-.78 2.48-2.04 2.56-1.51.1-2.34-.79-2.34-.79l.32-1.36s.84.63 1.5.59c.44-.03.6-.38.58-.63-.06-1.04-1.77-.98-1.88-2.69-.09-1.44.86-2.9 2.94-3.03.8-.05 1.21.15 1.21.15l-.48 1.78s-.53-.24-1.16-.2c-.92.06-.93.64-.92.78zm5.72-4.98c-.03-.42-.09-1.01-.29-1.52.63.12.94.84 1.07 1.27l-.78.25z"
      />
    </svg>
  );
}

export function WooCommerceMark({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden>
      <circle cx="16" cy="16" r="16" fill="#7F54B3" />
      <path
        fill="#fff"
        d="M6.6 11.4h18.8c.9 0 1.6.72 1.6 1.6v5.3c0 .88-.72 1.6-1.6 1.6H18.9l.93 2.27-4.08-2.27H6.6a1.6 1.6 0 0 1-1.6-1.6V13c0-.88.72-1.6 1.6-1.6z"
      />
      <path
        fill="#7F54B3"
        d="M7.3 13.3c.1-.14.25-.21.45-.23.36-.3.57.14.62.5.24 1.6.5 2.96.78 4.07l1.7-3.23c.15-.29.34-.45.57-.46.33-.03.54.19.62.63.19 1.02.43 1.89.73 2.62.2-2 .55-3.44 1.04-4.33.09-.16.21-.24.38-.26.13-.1.26.3.37.11.11.08.17.19.18.32a.44.44 0 0 1-.7.3c-.3.56-.55 1.4-.74 2.5-.19 1.07-.26 1.9-.22 2.5.1.16 0 .3-.6.43a.43.43 0 0 1-.35.23c-.15.01-.3-.05-.45-.2-.53-.54-.95-1.35-1.26-2.43-.37.73-.65 1.28-.83 1.64-.34.66-.63.99-.88 1.01-.16.02-.29-.11-.4-.39-.3-.77-.62-2.25-.96-4.44-.02-.15 0-.29.1-.4zM25.5 14.6c-.21-.9-.7-1.42-1.5-1.57a2 2 0 0 0-.4-.04c-.99 0-1.79.5-2.4 1.53a5.5 5.5 0 0 0-.75 2.86c0 .8.16 1.48.5 2.04.2.9.7 1.42 1.5 1.57.14.03.27.04.4.04 1 0 1.8-.51 2.4-1.53a5.5 5.5 0 0 0 .75-2.87c0-.8-.17-1.48-.5-2.03zm-1.18 2.8c-.14.66-.4 1.16-.77 1.5-.3.26-.57.37-.82.32-.24-.05-.44-.26-.59-.64a2.5 2.5 0 0 1-.22-1.03c0-.3.03-.6.09-.87.1-.5.3-.98.6-1.44.37-.56.77-.79 1.18-.7.24.5.44.26.59.63.11.3.18.63.18 1 0 .43-.4.83-.24 1.24zM19.7 14.6c-.2-.9-.7-1.42-1.5-1.57a2 2 0 0 0-.4-.04c-.98 0-1.78.5-2.4 1.53a5.5 5.5 0 0 0-.74 2.86c0 .8.16 1.48.5 2.04.2.9.7 1.42 1.5 1.57.13.03.27.04.4.04 1 0 1.8-.51 2.4-1.53a5.5 5.5 0 0 0 .74-2.87c0-.8-.16-1.48-.5-2.03zm-1.18 2.8c-.14.66-.4 1.16-.77 1.5-.3.26-.57.37-.82.32-.24-.05-.44-.26-.58-.64a2.5 2.5 0 0 1-.23-1.03c0-.3.03-.6.09-.87.1-.5.3-.98.6-1.44.38-.56.77-.79 1.18-.7.25.5.44.26.59.63.12.3.18.63.18 1 0 .43-.4.83-.24 1.24z"
      />
    </svg>
  );
}

export function MagentoMark({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden>
      <circle cx="16" cy="16" r="16" fill="#F26322" />
      <path
        fill="#fff"
        d="M16 5 6.6 10.4v11.2l2.7 1.56V11.96L16 8.06l6.7 3.9v11.2l2.7-1.56V10.4zm1.35 18.9L16 24.7l-1.36-.78v-11.2l-2.7 1.56v11.2L16 27.9l4.06-2.42v-11.2l-2.7-1.56z"
      />
    </svg>
  );
}

export function BigCommerceMark({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden>
      <circle cx="16" cy="16" r="16" fill="#0D52FF" />
      <path
        fill="#fff"
        d="M22.6 6.6 6.6 22.4v2.3c0 .4.32.7.7.7h11.3l9.6-9.5c.2-.2.3-.5.3-.8V7.3c0-.4-.32-.7-.7-.7zM12.4 20.3V17h3.1c.95 0 1.6.62 1.6 1.65 0 .96-.65 1.65-1.6 1.65zm0-6v-3.1h2.9c.9 0 1.5.55 1.5 1.5 0 .95-.6 1.6-1.5 1.6z"
      />
    </svg>
  );
}

export function HeadlessMark({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden>
      <circle cx="16" cy="16" r="16" fill="#0B0D12" />
      <path
        d="M12.4 11 7.8 16l4.6 5M19.6 11l4.6 5-4.6 5M17.6 9.4l-3.2 13.2"
        stroke="#fff"
        strokeWidth="2.1"
        strokeLinecap="round"
