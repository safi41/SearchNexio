...
/* ---- Start Your Crypto SEO Review: dark panel, copy left, form right.
   Six fields per the brief. Submission is inert in this build. ---- */
              ...
              <div className="rounded-3xl bg-surface p-7 shadow-[0_30px_80px_rgba(11,13,18,0.35)] md:p-8">
                {sent ? (
                  <div className="grid min-h-[360px] place-items-center text-center">
                    <div>
                      ...
                      <p className="mx-auto mt-2 max-w-sm text-[14px] leading-relaxed text-graphite">
                        Thank you. Search Nexio will review your details and follow up about your crypto SEO audit.
                      </p>
                    </div>
                  </div>
                ) : (
                  ...
                  >
                    ...
                    <p className="mt-4 text-[11.5px] leading-relaxed text-graphite">{CRYPTO_FINAL.privacy}</p>
                  </form>
                )}
              </div>
            </Reveal>
